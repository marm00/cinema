...
Commands are formatted like: `[(screen(s)) command (argument(s))]` Example 1: `2 4 search foo` plays file names containing foo on screens 2 and 4. Example 2: `autoplay` enables autoplay for all screens.
...
`macro` Execute macro [macro (*name*)]. Processes a macro command by command. Stored in cinema.conf.
